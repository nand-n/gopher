...
This continious unitl all functions int he executing goroutine have stopped , in revere order . At that point , the program is terminated and the error condition is reported including the value of the argment to panic.This termination sequence is called panicking and can be controlled by the built-in funcion recover.
